...
class PostAdapter(options: FirestoreRecyclerOptions<Post>,val listener: IPostAdapter) : FirestoreRecyclerAdapter<Post, PostAdapter.PostViewHolder>(options) {
    ...
    override fun onBindViewHolder(holder: PostViewHolder, position: Int, model: Post) {
        ...
        //now the created at was a long time, and we want it to be more understandable to the user, like a minute ago
        //etc. so we do it like this-->
        //we make that code of ours, a util
